...
def mkDataSet(data_size, data_length=25, freq=60., noise=0.00):
    """
    params\n
    data_size : データセットサイズ\n
...
def mkRandomBatch(train_x, train_t, batch_size=1):
    """
...
def main():
    ...
    for epoch in range(epochs_num):
        ...
        for i in range(int(test_size / batch_size)):
            offset = i * batch_size
            data, label = torch.tensor(test_x[offset:offset + batch_size]), torch.tensor(
